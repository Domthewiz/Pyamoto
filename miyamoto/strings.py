    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'PrefsDlg': {
                ...
                2: 'Toolbar',
                3: 'Themes',
                4: '[b]General[/b][br]Customize language, file handling, and other general settings.',
                5: '[b]Toolbar[/b][br]Choose which actions appear on the toolbar.',
                6: '[b]Themes[/b][br]Pick a theme to change the application\'s colors and icons.',
