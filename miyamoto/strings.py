    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'AreaChoiceDlg': {
                0: 'Choose an Area',
                1: 'Area [num]',
                2: 'You have reached the maximum amount of areas in this level.[br]Due to the game\'s limitations, Pyamoto only allows you to add up to 4 areas to a level.',
                },
            'AreaCombobox': {
                0: 'Area [num]',
                },
            'AreaDlg': {
                ...
                19: '[name] ([file])',
                20: 'Enter a Filename',
                21: 'Enter the name of a custom tileset file to use. It must already be inside the level archive in order for Pyamoto to recognize it.',
                22: 'Unknown Value 1:',
                23: 'Unknown Value 2:',
                ...
                36: 'Timer 2:',
                37: 'Timer 3:',
                38: '[b]Timer 2 & 3:[/b]This time limit is chosen by the nybble 12 on actor 25, Checkpoint Flag. See actor for details.',
            ...
            'AutoSaveDlg': {
                ...
                1: 'Pyamoto has found some level data which wasn\'t saved - possibly due to a crash within the editor or by your computer. Do you want to restore this level?[br][br]If you pick No, the autosaved level data will be deleted and will no longer be accessible.[br][br]Original file path: [path]',
                2: 'Warning',
            ...
            'BGDlg': {
                ...
                22: 'Warning',
                23: '"Lava 2" BG requires actors: 473, 477, 487, 497.[br]Of course, you have to set up those actors correctly in order for the game to not crash.[br]Go take a look at 8-43 Area 3.',
                },
            'ChangeGamePath': {
                ...
                3: 'This folder doesn\'t seem to have the required files. In order to use Pyamoto, you need the "course_res_pack" folder from the game and the level files contained within it.',
                },
            'Comments': {
                0: '[x], [y]: [text]',
            ...
            'EntranceDataEditor': {
                ...
                23: '[b]Entrance [id]:[/b]',
                24: 'Selected Entrance Properties',
                25: 'Exit Direction:',
            ...
            'Err_BrokenSpriteData': {
                0: 'Warning',
                1: 'The actor data file didn\'t load correctly. The following actors have incorrect and/or broken data in them, and may not be editable correctly in the editor: [sprites]',
                2: 'Errors',
                },
            'Err_CantFindLevel': {
            ...
            'Err_MissingFiles': {
                0: 'Error',
                1: 'Sorry, you seem to be missing the required data files for Pyamoto to work. Please redownload your copy of the editor.',
                2: 'Sorry, you seem to be missing some of the required data files for Pyamoto to work. Please redownload your copy of the editor. These are the files you are missing: [files]',
                },
            'Err_MissingLevel': {
                0: 'Error',
            ...
            'Gamedefs': {
                0: 'This game has custom actor images',
                1: 'Loading patch...',
                2: 'New Game Patch',
                ...
                8: 'Loading actor data...',
                9: 'Loading background names...',
                10: 'Reloading tilesets...',
                11: 'Loading actor image data...',
                12: 'Applying actor image data...',
            ...
            'LocationDataEditor': {
                ...
                10: 'Snap to Grid',
                11: '[b]Location [id]:[/b]',
                12: 'Selected Location Properties',
                },
            'Locations': {
                0: '[id]',
            ...
            'MenuItems': {
                ...
                18: 'Pyamoto Preferences...',
                19: 'Change important Pyamoto settings',
                20: 'Exit Pyamoto',
                21: 'Exit the editor',
                22: 'Select All',
                ...
                54: 'Show Actors',
                55: 'Toggle viewing of actors',
                56: 'Show Actor Images',
                57: 'Toggle viewing of actor images',
                58: 'Show Locations',
                ...
                92: 'About PyQt...',
                93: 'About the Qt library Pyamoto is based on',
                94: 'Level Overview',
                95: 'Show or hide the Level Overview window',
                96: 'Palette',
                97: 'Show or hide the Palette window',
                98: 'Manage Mods',
                99: 'Change the currently loaded Pyamoto game patch',
                ...
                121: 'Check if any updates for Pyamoto are available to download',
                ...
                128: 'Reload Actor Data',
                129: 'Reload the actor data without restarting the editor',
                ...
                134: 'Don\'t overwrite actors in the level archive',
                135: 'Don\'t overwrite actors in the level archive with actors from the data folder',
            ...
            'Palette': {
                ...
                8: 'Entrances currently in this area[br](Double-click one to jump to it instantly, hover for preview)',
                ...
                11: 'Actors currently in this area[br](Double-click one to jump to it instantly, hover for preview)',
                12: 'Locations currently in this area[br](Double-click one to jump to it instantly, hover for preview)',
                13: 'Objects',
                14: 'Actors',
                15: 'Entrances',
                16: 'Locations',
                ...
                32: 'Save Set As...',
                33: 'Comments',
                34: 'Comments currently in this area[br](Double-click one to jump to it instantly, hover for preview)',
                35: 'Name:',
                36: 'Nabbit Path',
                37: 'Nabbit Path nodes currently in this area[br](Double-click one to jump to it instantly, hover for preview)',
                },
            'PathDataEditor': {
                0: 'Loops:',
                ...
                8: '[b]Path [id][/b]',
                9: '[b]Node [id][/b]',
                10: 'Selected Path Node Properties',
                11: 'Unknown 0x01:',
                12: '[b]Unknown 0x01:[/b][br]No idea what this is',
                13: 'Selected Nabbit Path Node Properties',
            ...
            'PrefsDlg': {
                0: 'Pyamoto Preferences',
                1: 'General',
                2: 'Toolbar',
                3: 'Themes',
                4: '[b]Pyamoto Preferences[/b][br]Customize Pyamoto by changing these settings.[br]Use the tabs below to view even more settings.[br]Pyamoto must be restarted before certain changes can take effect.',
                5: '[b]Toolbar Preferences[/b][br]Choose menu items you would like to appear on the toolbar.[br]Pyamoto must be restarted before the toolbar can be updated.[br]',
                6: '[b]Pyamoto Themes[/b][br]Pick a theme below to change application colors and icons.[br]Pyamoto must be restarted before the theme can be changed.',
                ...
                18: 'Are you sure you want to clear the recents list? This [b]can\'t[/b] be undone!',
                19: 'Current Area',
                20: 'Reset',
                21: 'Available Themes',
                22: 'Preview',
                ...
                30: 'You may need to restart Pyamoto for changes to take effect.',
            ...
            'ShftItmDlg': {
                0: 'Shift Items',
                1: 'Move objects by:',
                2: 'Enter an offset in pixels - each block is 16 pixels in size. Note that normal objects can only be placed on 16x16 boundaries, so if the offset you enter isn\'t a multiple of 16, they won\'t be moved correctly.',
                3: 'X:',
                4: 'Y:',
                5: 'Warning',
                6: 'You are trying to move object(s) by an offset which isn\'t a multiple of 16. It will work, but the objects will not be able to move exactly the same amount as the actors. Are you sure you want to do this?',
                },
            'Splash': {
            ...
            'SpriteDataEditor': {
                0: 'Selected Actor Properties',
                1: '[b][name][/b]: [note]',
                2: '[b]Actor Notes:[/b] [notes]',
                3: 'Edit Raw Data:',
                4: 'Notes',
                5: '[b]Unidentified/Unknown Actor ([id])[/b]',
                6: '[b]Actor [id]:[br][name][/b]',
                7: 'Object Files',
                8: '[b]This actor uses:[/b][br][list]',
                9: 'Layer:',
                10: ('Layer 1', 'Layer 2', 'Layer 0'),
                11: '[b]Layer:[/b][br]Allows you to change the layer which this actor is active on. This field is not read in-game by some actors - for almost all normal cases, you will want to use layer 1.',
                12: 'Initial State:',
                13: '[b]Initial State:[/b][br]Used by some actors to initiate in a different state depending on the value of this field.',
                },
            'Sprites': {
                0: '[b]Actor [type]:[/b][br][name]',
                1: '[name] (at [x], [y]',
            ...
            'Statusbar': {
                ...
                24: '- Actor under mouse: [name] at [xpos], [ypos]',
            ...
            'ZonesDlg': {
                ...
                17: 'Select Preset:',
                18: '[b]Select Preset:[/b][br]Snaps the zone to common sizes.[br]The number before each entry specifies which zoom level works best with each size.',
                ...
                28: 'Full Darkness',
                29: '[b]Visibility - Full Darkness:[/b][br]Sets the visibility mode to full darkness. In full dark mode,[br]the screen is completely black and visibility is only provided[br]by the available spotlight effect. Stars and some actors[br]can enhance the default visibility.',
                30: 'X Tracking:',
                ...
                58: 'Boss Flag:',
                59: '[b]Boss Flag:[/b][br]Set for bosses to allow proper music switching by actors',
                60: '(None)',
                61: 'Error',
